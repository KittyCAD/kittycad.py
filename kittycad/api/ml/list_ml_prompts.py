...
def _parse_response(*, response: httpx.Response) -> MlPromptResultsPage:
...
def _build_response(*, response: httpx.Response) -> Response[MlPromptResultsPage]:
