...
def _parse_response(*, response: httpx.Response) -> ApiTokenResultsPage:
...
def _build_response(*, response: httpx.Response) -> Response[ApiTokenResultsPage]:
