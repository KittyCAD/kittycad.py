...
def _parse_response(*, response: httpx.Response) -> ShortlinkResultsPage:
...
def _build_response(*, response: httpx.Response) -> Response[ShortlinkResultsPage]:
