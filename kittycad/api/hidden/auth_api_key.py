...
def _parse_response(*, response: httpx.Response) -> AuthApiKeyResponse:
...
def _build_response(*, response: httpx.Response) -> Response[AuthApiKeyResponse]:
