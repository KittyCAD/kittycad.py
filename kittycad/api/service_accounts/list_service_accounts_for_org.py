...
def _parse_response(*, response: httpx.Response) -> ServiceAccountResultsPage:
...
def _build_response(*, response: httpx.Response) -> Response[ServiceAccountResultsPage]:
...
def sync_detailed(
    ...
    *,
    ...
    limit: Optional[int] = None,
    page_token: Optional[str] = None,
) -> Response[ServiceAccountResultsPage]:
    kwargs = _get_kwargs(
        limit=limit,
