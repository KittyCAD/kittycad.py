...
def _parse_response(*, response: httpx.Response) -> UnitPressureConversion:
...
def _build_response(*, response: httpx.Response) -> Response[UnitPressureConversion]:
...
def sync_detailed(
    ...
    *,
    client: Client,
) -> Response[UnitPressureConversion]:
    kwargs = _get_kwargs(
        input_unit=input_unit,
        output_unit=output_unit,
        value=value,
