...
def _parse_response(*, response: httpx.Response) -> UnitForceConversion:
...
def _build_response(*, response: httpx.Response) -> Response[UnitForceConversion]:
