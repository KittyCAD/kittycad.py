...
def _parse_response(*, response: httpx.Response) -> UnitAreaConversion:
...
def _build_response(*, response: httpx.Response) -> Response[UnitAreaConversion]:
