...
def _parse_response(*, response: httpx.Response) -> UnitTemperatureConversion:
...
def _build_response(*, response: httpx.Response) -> Response[UnitTemperatureConversion]:
...
def sync_detailed(
    ...
    *,
    client: Client,
) -> Response[UnitTemperatureConversion]:
    kwargs = _get_kwargs(
        input_unit=input_unit,
        output_unit=output_unit,
        value=value,
