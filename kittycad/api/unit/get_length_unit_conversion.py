...
def _parse_response(*, response: httpx.Response) -> UnitLengthConversion:
...
def _build_response(*, response: httpx.Response) -> Response[UnitLengthConversion]:
