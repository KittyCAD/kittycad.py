...
def _parse_response(*, response: httpx.Response) -> UnitEnergyConversion:
...
def _build_response(*, response: httpx.Response) -> Response[UnitEnergyConversion]:
