...
def _parse_response(*, response: httpx.Response) -> UnitCurrentConversion:
...
def _build_response(*, response: httpx.Response) -> Response[UnitCurrentConversion]:
...
def sync_detailed(
    ...
    *,
    client: Client,
) -> Response[UnitCurrentConversion]:
    kwargs = _get_kwargs(
        input_unit=input_unit,
        output_unit=output_unit,
        value=value,
