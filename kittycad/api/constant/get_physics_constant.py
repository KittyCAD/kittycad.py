...
def _get_kwargs(
	...
	*,
	...
	url = "{}/constant/physics/{constant}".format(client.base_url, constant=constant) # noqa: E501
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[PhysicsConstant, Error]]:
...
def _build_response(*, response: httpx.Response) -> Response[Optional[Union[PhysicsConstant, Error]]]:
	return Response(
