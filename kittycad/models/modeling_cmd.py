...
class default_camera_perspective_settings(BaseModel):
    ...
    type: Literal["default_camera_perspective_settings"] = "default_camera_perspective_settings"
...
class default_camera_enable_sketch_mode(BaseModel):
    ...
    type: Literal["default_camera_enable_sketch_mode"] = "default_camera_enable_sketch_mode"
...
class default_camera_disable_sketch_mode(BaseModel):
    ...
    type: Literal["default_camera_disable_sketch_mode"] = "default_camera_disable_sketch_mode"
...
class path_get_curve_uuids_for_vertices(BaseModel):
    ...
    type: Literal["path_get_curve_uuids_for_vertices"] = "path_get_curve_uuids_for_vertices"
...
ModelingCmd = RootModel[Annotated[Union[
